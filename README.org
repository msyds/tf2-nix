...
- [ ] VPK builder.
- [X] Configure launch options (Is this feasible?).
  + See [[https://github.com/different-name/steam-launch.nix][steam-launch.nix]]
...
-  [[https://github.com/different-name/steam-launch.nix][steam-launch.nix]], a Home-manager module for setting launch options for Steam games (such as Team Fortress 2!)
